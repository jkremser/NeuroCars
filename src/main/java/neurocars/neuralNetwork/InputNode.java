...
public class InputNode implements Serializable {
   ...
   *          pridavany node
   */
  public void addNextLayerNode(HiddenNode node, double initialValue) {
    if (nextLayerNodes == null)
      System.out.println("null");

    nextLayerNodes.add(node);
    nextLayerNodesWeights.add(initialValue);
  }
  ...
  /**
   * Upravi vahu pro kazdy neuron nasledujici skryte vrstvy (podle hodnoty jeho
   * chyby a vstupu do nej)
   * 
   * @param iteration
