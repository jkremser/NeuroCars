...
public class DataItem {
  ...
  /**
   * Konstruktor, ktery slouzi k vytvoreni instance, ktera uchovava jen vstupni
   * data
   * 
   * @param inputLength
   */
  ...
  /**
   * Konstruktor, pomoci nehoz muzeme vytvorit instanci uchovavajici: a) vstupni
   * i vystupni data b) jen vystupni data, pokud inputLength je -1
   * 
   * @param inputLength
   * @param outputLength
   */
