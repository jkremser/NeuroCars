...
public class Transformer {
	...
	/**
	 * Prevod mezi dvouma formaty podle specifikace Jestli se neco bude menit,
	 * tak tady
	 * 
	 * @param input
	 * @return
	...
	/**
	 * Prevod DataItem obsahujici jen vystup na NeuralNetworkOutput Pozor,
	 * takhle muze vyjit brzda i plyn soucasne TODO: plyn-brzda pripadne
	 * doprava-doleva vzdy prevezt na 1 neuron, jehoz vystup by se mapoval na
	 * -1/0/1. V tom pripade je ale treba i zmena v datech ze souboru. To bude
	 * asi nejlehci reseni. Jeste by se to mohlo menit pri nacitani ze souboru,
	 * ale zbytecne komplikovane
	 * 
	 * @param outputDI
	 * @return
	 */
	...
	private static boolean closerToOne(double value) {
		if (Math.abs(1 - value) < Math.abs(value)) {
			return true;
		}
		return false;
	}
