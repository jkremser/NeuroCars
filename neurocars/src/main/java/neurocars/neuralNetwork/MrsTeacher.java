...
public class MrsTeacher {
  ...
  public void learn() {
    if ((args.length != 6 && args.length != 8) || (!"-o".equals(args[0]))
       ...
       * neurocars.neuralNetwork.InputNode.addNextLayerNode(InputNode.java:36)
       */
      // net.learn();
    }
  }
